...
$setip = "set mgmt-ip "+$IPAdd

Set-VMKeystrokes -VMName $VM -StringInput "admin" -ReturnCarriage $true
sleep 1
Set-VMKeystrokes -VMName $VM -ReturnCarriage $true
sleep 1
Set-VMKeystrokes -VMName $VM -StringInput $setip -DebugOn $true -ReturnCarriage $true
sleep 1
Set-VMKeystrokes -VMName $VM -StringInput "status" -ReturnCarriage $true
sleep 1

#Set-VMKeystrokes -VMName $VM -StringInput "shutdown" -ReturnCarriage $true
#sleep 1
#Set-VMKeystrokes -VMName $VM -StringInput "Y" -ReturnCarriage $true

Set-VMKeystrokes -VMName $VM -StringInput "update-license" -ReturnCarriage $true
sleep 1

Get-Content $LicFile | ForEach-Object {
    $LicLine = $_
    Set-VMKeystrokes -VMName $VM -StringInput $LicLine -ReturnCarriage $true
}

Set-VMKeystrokes -VMName $VM -StringInput "Y" -ReturnCarriage $true
# FIS should reboot now
